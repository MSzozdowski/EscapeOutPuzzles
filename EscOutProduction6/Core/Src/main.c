...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : DEBUG_LED_Pin LCD_A0_LEFT_Pin LCD_RST_LEFT_Pin LCD_CS_LEFT_Pin
  ...
  /*Configure GPIO pins : LCD_CS_RIGHT_Pin LCD_PWR_LEFT_Pin RELAY_Pin RS_485_EN_Pin */
  ...
  /*Configure GPIO pins : MCU_SEL2_Pin MCU_SEL3_Pin MCU_SEL4_Pin */
