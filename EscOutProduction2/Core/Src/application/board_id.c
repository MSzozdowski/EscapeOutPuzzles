...
board_id_t BOARD_ID_GetBoardID(void)
{
	...
	if(board_id_millivolts > REED_SWITCH_MILLIVOLTS_THRESHOLD_MIN && board_id_millivolts < REED_SWITCH_MILLIVOLTS_THRESHOLD_MAX)
	{
		return BOARD_IS_REED_SWITCH;
	}
	else if(board_id_millivolts > BUTTON_GAME_MILLIVOLTS_THRESHOLD)
	{
		return BOARD_IS_BUTTON_GAME;
	}
	else if(board_id_millivolts < METAL_BALL_MILLIVOLTS_THRESHOLD)
	{
		return BOARD_IS_METAL_BALL;
	}
	else
	{
